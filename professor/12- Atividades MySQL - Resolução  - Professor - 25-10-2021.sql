...
select materiais.nome_material, unidades.nome_unidade
from materiais, unidades
where materiais.id_unidade = unidades.id_unidade and unidades.nome_unidade = 'Unidade';
...
on materiais.id_unidade = unidades.id_unidade
group by unidades.nome_unidade
order by unidades.nome_unidade;

/* 5 - Nome do material, nome do fornecedor e nome da unidade */
select materiais.nome_material, fornecedores.nome_fornecedor, unidades.nome_unidade
from materiais, fornecedores, unidades
where materiais.id_fornecedor = fornecedores.id_fornecedor and materiais.id_unidade = unidades.id_unidade;
...
select fornecedores.nome_fornecedor, materiais.nome_material
from fornecedores left join materiais
...
where itens_pedido.id_material = materiais.id_material
order by materiais.nome_material;

/* 26 - Materiais que não constam nos pedidos */
select materiais.nome_material
from materiais left join itens_pedido
on itens_pedido.id_material = materiais.id_material
where itens_pedido.id_material is null
order by materiais.nome_material;

/* 27 - Número do pedido e a quantidade de itens em cada pedido */
select itens_pedido.id_pedido, count(itens_pedido.id_material) as quant_itens
from itens_pedido
...
delete from itens_pedido -- Exclui o material da tabela "ïtens_pedidos"
where itens_pedido.id_material = '13';

select * from itens_pedido;

delete from materiais -- Exclui o material da tabela "materiais"
...
where itens_pedido.id_item_pedido = '1'; -- Exclui o item de pedido '1'', que possui materiais do fornecedor "XYZ Materiais de Escritório"

delete from itens_pedido
where itens_pedido.id_item_pedido = '4'; -- Exclui o item de pedido '4', que possui materiais do fornecedor "XYZ Materiais de Escritório"

delete from materiais
where materiais.id_fornecedor = '2'; -- Exclui os materiais do fornecedor "XYZ Materiais de Escritório"

select * from materiais;

delete from fornecedores -- Exclui o fornecedor "XYZ Materiais de Escritório"
